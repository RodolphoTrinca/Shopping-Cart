  ...
  return (
    <div className="flex items-center justify-between border-b py-2">
      <div className="flex items-center min-w-[180px] max-w-[250px] sm:min-w-[220px] sm:max-w-[400px] md:min-w-[320px] md:max-w-[700px] lg:min-w-[400px] lg:max-w-[800px]">
        <img src={item.image} alt={item.name} className="w-16 h-16 min-w-[64px] min-h-[64px] max-w-[64px] max-h-[64px] object-contain bg-white border rounded block" />
        <div className="flex flex-col justify-center ml-6 gap-1 flex-1">
          <h3 className="font-semibold w-full line-clamp-2 overflow-hidden text-ellipsis">{item.name}</h3>
